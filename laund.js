...
sinkButton.addEventListener("click", function()
  {
  document.getElementById("text").innerHTML = "Faucets use up to 1.5 gallons of water in a minute. This doesn’t seem like too much, but it builds up when you leave the faucet on while brushing your teeth, etc."
  }
);
// sink
